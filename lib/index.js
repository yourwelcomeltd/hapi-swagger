    ...
    plugin.ext('onPostHandler', (request, reply) => {
        ...
        if (response.variety === 'view') {
            ...
            if (plugin.realm.modifiers.route.prefix) {
				...
				// Prefix the swagger UI path with . so that the paths in the html are relative to the documentation URL, rather than
				// to the root.
                prefixedSettings['swaggerUIPath'] = '.' + prefixedSettings['swaggerUIPath'];
			}
